//
//  View+navigationAllowSwipeBackWhenHidden.swift
//  devRantAvatarEditor
//
...
private struct NavigationConfigurator: UIViewControllerRepresentable {
    ...
    func updateUIViewController(_ uiViewController: UIViewController, context: UIViewControllerRepresentableContext<NavigationConfigurator>) {
        ...
        guard let originalDelegate = uiViewController.navigationController?.interactivePopGestureRecognizer?.delegate,
              !(originalDelegate is Coordinator) else { return }
